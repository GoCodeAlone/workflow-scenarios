...
export default function DashboardPage() {
  return (
    <div>
      <h1 style={headStyle}>Payment Service</h1>
      <p>Welcome to the dashboard. Use the navigation to explore the API resources.</p>
      <div style={cardGridStyle}>
        <a href="/payments" style={cardStyle}>
          <div style={cardTitleStyle}>Payments</div>
        </a>
        <a href="/capture" style={cardStyle}>
          <div style={cardTitleStyle}>Capture</div>
        </a>
        <a href="/refund" style={cardStyle}>
          <div style={cardTitleStyle}>Refund</div>
        </a>
